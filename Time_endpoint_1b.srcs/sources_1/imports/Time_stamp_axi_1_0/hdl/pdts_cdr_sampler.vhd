...
iff : IDDRE1
   ...
   port map (
      Q1 => da, -- 1-bit output: Registered parallel output 1
      Q2 => db, -- 1-bit output: Registered parallel output 2
      C => clk4x,   -- 1-bit input: High-speed clock
      CB => clk4x, -- 1-bit input: Inversion of High-speed clock C
	...
	--iff: IDDRE1
		...
		--	d => d,
		--	c => clk4x,
			--ce => '1',   I TOOK THIS OUT
		--	q1 => da,
		--	q2 => db,
		--	CB => clk4x,   --- i PUT THIS IN
		--	r => '0'
		--	--s => '0'
	--	);
